    ...
    public function run(): void
    {
        ...
        DB::table('componentes')->insert([
            ...
            [
                ...
                'ruta_incono' => 'bi-thermometer-half',
                'created_at'  => now(),
                'updated_at'  => now(),
            ],
            [
            ...
            [
                ...
                'ruta_incono' => 'bi-arrow-left-right',
                'created_at'  => now(),
                'updated_at'  => now(),
            ],
            [
            ...
            [
                ...
                'ruta_incono' => 'bi-gear-wide-connected',
                'created_at'  => now(),
                'updated_at'  => now(),
            ],
            [
